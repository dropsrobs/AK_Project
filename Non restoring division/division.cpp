...
struct Bignum
{
    ...
    void operator<<(Bignum &other)
    {
        ...
        { result_this.bin_num[i] = bin_num[i + 1]; }
        ...
        { result_other.bin_num[i] = other.bin_num[i + 1]; }
        result_other.bin_num[other.size - 1] = false;

        for(int i = 0; i != other.size; i++)
        { other.bin_num[i] = result_other.bin_num[i]; }
    }
